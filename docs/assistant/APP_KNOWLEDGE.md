...
- Canonical current-truth also includes stronger shared visual elevation across the dashboard and core dialogs through centralized `qt_gui/styles.py` selectors and objectName-based chrome, instead of dialog-local inline styling.
