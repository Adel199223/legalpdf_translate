...
Canonical main includes PR #304 at `1d6fdb3`, preserving the earlier PR #303 readiness fixes. The Word-startup change passed targeted/Full/CI validation, canonical application and one independently reviewed default native-readiness pair. English reviewed formatting and a genuinely saved Gmail output retain qualified evidence; Arabic follow-up remains active and upload-blocked with no AR02 provider dispatch. Use [HANDOFF.md](HANDOFF.md) for exact identities, bounds and acceptance limits. Native readiness does not establish Gmail finalization or legal-document quality. Assistant model preference remains separate from app provider policy and saved settings.
