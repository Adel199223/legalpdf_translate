...
The accepted footer/spacing follow-up passed local integration checks and is awaiting publication/merge before daily-use availability. With source-page breaks off and complete matching saved structure, it keeps clear space around headers/body text and can place a proven contact block at the bottom of a complete one-source-page output. That exception does not turn an isolated heading or legal paragraph into repeated page furniture. The [integration plan](../exec_plans/active/2026-09-09_footer_spacing_integration.md) tracks availability; it is not a claim about every new translation.
