...
4. Ask the docs sync prompt only if the change is significant, relevant touched-scope docs still remain unsynced, and immediate same-task synchronization is necessary.
