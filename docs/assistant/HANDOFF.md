...
Updated 2026-09-16. Read `AGENTS.md` and `agent.md`, then this page. Current user instructions and explicit operation scopes take precedence over historical continuation text. Do not replay a consumed provider/native helper or renew an obsolete stage/credit gate merely because an old file says pending.
