...
- **Current status:** the accepted Arabic reliability fixes are published through PR #298; the [publication closeout](docs/assistant/exec_plans/completed/2026-09-17_arabic_acceptance_publication.md) records the actual merge, CI, canonical HTTP verification and cleanup. No acceptance or publication replay remains. Optional UI polish and new paid/native experiments remain deferred.
