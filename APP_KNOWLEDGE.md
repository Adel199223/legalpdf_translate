...
- **Current priority:** publish the accepted Arabic reliability changes through the [scoped publication plan](docs/assistant/exec_plans/active/2026-09-17_arabic_acceptance_publication.md), now authorized by the user. The checks and actual acceptance below apply to the isolated candidate; canonical availability requires the recorded PR merge and checkout verification. Optional UI polish and new paid/native experiments are deferred.

- **Daily-use build:** canonical `C:/Users/FA507/.codex/legalpdf_translate`, branch `main`. PR #296 published the reviewed app at `068e4312269106e26677185ae33bc1b556e3c073`; PR #297 published the documentation follow-up. On 2026-09-17, canonical HEAD, `origin/main` and the live remote were verified at `2e31edccad2252c20d55332fe5167c7ff439460f`. Recheck actual Git/process state before work.
- **Completed isolated acceptance:** [Arabic normal-browser acceptance](docs/assistant/exec_plans/completed/2026-09-17_arabic_normal_browser_acceptance.md), worktree `legalpdf_translate_arabic_acceptance`, branch `feat/arabic-browser-acceptance-20260917`. Its bounded signature/witness spacing, Arabic prompt/citation, source-startup race, recovery-copy and formatting UI fixes are unpublished. Each retained inventory identifies its exact tested snapshot. The citation/prompt follow-up passed975 targeted tests; the frozen E snapshot passed627 selected Full tests. Later formatting UI fixes dismiss the originating overflow menu and avoid a new image read during busy actions;24 focused tests, separate Chromium geometry checks and the final629-test Full wrapper passed.
