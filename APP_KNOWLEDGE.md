...
Current publication task (September24): the user authorized the full PR/CI/merge lifecycle, canonical update, scoped docs/harness sync, worktree cleanup and a fresh-chat handoff. Follow the [publication plan](docs/assistant/exec_plans/active/2026-09-24_multilingual_acceptance_publication.md). The tested integration is based on fetched main `7a86cd07`; required local Full639 and focused39 evidence remains applicable to the unchanged code. The changes are not published yet. Preserve all qualified acceptance outcomes, the incomplete French document and its uncertain charge; this publication does not start another paid/Gmail/native acceptance case.

- **Completed requested testing:** the [multilingual/Gmail campaign](docs/assistant/exec_plans/completed/2026-09-17_multilingual_gmail_acceptance.md) and [September24 recovery](docs/assistant/exec_plans/completed/2026-09-24_acceptance_interruption_recovery.md) are closed with recorded outcomes. ENshort01, FRshort02 and ordinary ARshort03 have qualified real-output/native review; AR03 optional formatting remains unaccepted. FRlong01 failed after 5 of 9 source-page translations, which survive in an exact partial DOCX. The unknown page6 charge retains USD0.119; lifetime known spend is USD3.92137740 under the original USD10 cap, and further paid dispatch remains blocked. Gmail passed exact-message loading, both PDF previews and one prepared session after user-operated read-only consent and manual recovery; no Gmail translation, draft or send occurred. Its setup422 and four actual readiness probe/canary pairs are preserved, with confirmed cleanup. All concrete fixes remain unpublished in the isolated worktree; 39 focused and 639 Full-selected tests passed. See [HANDOFF.md](docs/assistant/HANDOFF.md) for exact scopes, accounting, failures and evidence. Saved defaults, canonical source and historical evidence remain intact; publication and universal acceptance are not implied.
- **Latest completed publication:** the accepted Arabic reliability fixes are published through PR #298; the [publication closeout](docs/assistant/exec_plans/completed/2026-09-17_arabic_acceptance_publication.md) records the actual merge, CI, canonical HTTP verification and cleanup. PR #299 completed the documentation closeout at `7a86cd07a28496eecfbe3cc7e69398a611242184`, the new isolated task's base. No historical helper or acceptance operation is to be replayed. Optional unrelated UI polish remains deferred.

- **Daily-use build:** canonical `C:/Users/FA507/.codex/legalpdf_translate`, branch `main`. PR #298 merged at `751185fca959ab074c328050adf0184f5db76d2c` on 2026-09-17. Canonical main was updated to that revision, and owned isolated HTTP/runtime/static-asset verification result was recorded at 2026-09-17T19:44:52.8118593Z. The HTTP verification applies to that implementation revision. Later documentation-only revisions do not change its evidence scope or establish a new HTTP-tested HEAD. PRs #296 and #297 are earlier published history. Recheck actual Git/process state before work.
