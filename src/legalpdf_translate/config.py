...
DEFAULT_TRANSLATION_TIMEOUT_TEXT_SECONDS: Final[int] = 480
DEFAULT_TRANSLATION_TIMEOUT_IMAGE_SECONDS: Final[int] = 720
DEFAULT_OCR_API_TIMEOUT_SECONDS: Final[int] = 240
DEFAULT_METADATA_AI_TIMEOUT_SECONDS: Final[int] = 120

RUN_STATE_VERSION: Final[int] = 3

IMAGE_MAX_DATA_URL_BYTES: Final[int] = 20 * 1024 * 1024
IMAGE_MAX_DATA_URL_BYTES_ENFR: Final[int] = 4 * 1024 * 1024
IMAGE_MAX_DATA_URL_BYTES_AR: Final[int] = 8 * 1024 * 1024
